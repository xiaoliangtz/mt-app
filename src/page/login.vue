<template>
  <div class="page-login">
    ...
    <footer>
      <ul>
        <li><a href="http://www.meituan.com">关于美团</a></li>
        <li><a href="http://www.meituan.com">加入我们</a></li>
        <li><a href="http://www.meituan.com">商家入驻</a></li>
        <li><a href="http://www.meituan.com">帮助中心</a></li>
        <li><a href="http://www.meituan.com">美团手机版</a></li>
      </ul>
